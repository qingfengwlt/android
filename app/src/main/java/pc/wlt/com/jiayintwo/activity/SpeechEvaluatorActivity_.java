...
import pc.wlt.com.jiayintwo.common.utils.RecorderUtil;
import pc.wlt.com.jiayintwo.common.utils.ToastUtils;
import pc.wlt.com.jiayintwo.result.Result;
import pc.wlt.com.jiayintwo.result.xml.XmlResultParser;
import pc.wlt.com.superlibrary.utils.L;
/**
 * 语音测评 打分页面  备份
 */
public class SpeechEvaluatorActivity_ extends BaseAppCompatActivity implements EvaluatorListener {
...
//            @Override
//            public void run() {
                ToastUtils.showToast(SpeechEvaluatorActivity_.this,"score="+score);
//            }
//        });
